        ...
        <DialogContent>
          {!showPolicy ? (
            <Typography variant="body1" paragraph>
              Para atualizar seu cadastro já existente, basta refazer o cadastro
          ...
          {showPolicy ? (
            <>
              <Typography variant="body1" paragraph>
                ...
                Enfermeiros PICS". A sua privacidade é importante para nós. Esta
                política de privacidade descreve como coletamos, usamos e
                protegemos suas informações pessoais.
              </Typography>
              <Typography variant="body1" paragraph>
                <strong>2. Coleta de Informações:</strong> Coletamos informações
                pessoais que você nos fornece diretamente, como nome, e-mail e
                número de telefone, endereços, bem como dados de uso do site.
              </Typography>
              <Typography variant="body1" paragraph>
                <strong>3. Uso das Informações:</strong> Usamos suas informações
                para divulgar o perfil em nossa aplicação, além de fornecer e
                melhorar nossos serviços, comunicar atualizações e responder às
                suas solicitações.
              </Typography>
              <Typography variant="body1" paragraph>
              ...
              <Typography variant="body1" paragraph>
                ...
                esta política de privacidade periodicamente. Notificaremos você
                sobre quaisquer alterações significativas.
              </Typography>
              <Typography variant="body1" paragraph>
                <strong>8. Contato:</strong> Se tiver dúvidas sobre esta
                política de privacidade, entre em contato conosco via [e-mail].
              </Typography>
            </>
          ) : null}
          {!showPolicy ? (
